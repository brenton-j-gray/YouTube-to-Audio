...
def cookie_to_dict(cookie): # -> dict[str, Any]:
    ...

def cookie_jar_to_list(cookie_jar): # -> list[dict[str, Any]]:
    ...
...
class PhantomJSwrapper:
    ...
    def get(self, url, html=..., video_id=..., note=..., note2=..., headers=..., jscode=...): # -> tuple[str, Any | Literal['', b""]]:
        """
