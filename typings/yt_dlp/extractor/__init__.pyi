...
from ..globals import extractors as _extractors_context, plugin_ies as _plugin_ies_context
...
def list_extractor_classes(age_limit=...): # -> Generator[Any | type[GenericIE], Any, None]:
    """Return a list of extractors that are suitable for the given age, sorted by extractor name"""
    ...

def list_extractors(age_limit=...): # -> list[GenericIE | Any]:
