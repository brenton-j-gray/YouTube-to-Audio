...
from ..utils import FormatSorter, classproperty
...
class InfoExtractor:
    ...
    @staticmethod
    def url_result(url, ie=..., video_id=..., video_title=..., *, url_transparent=..., **kwargs): # -> dict[str, Any | str]:
        """Returns a URL that points to a page that should be processed"""
        ...
    
    @classmethod
    def playlist_from_matches(cls, matches, playlist_id=..., playlist_title=..., getter=..., ie=..., video_kwargs=..., **kwargs): # -> dict[str, Any | str]:
        ...
    
    @staticmethod
    def playlist_result(entries, playlist_id=..., playlist_title=..., playlist_description=..., *, multi_video=..., **kwargs): # -> dict[str, Any | str]:
        """Returns a playlist"""
        ...
    
    @classproperty(cache=True)
    def FormatSort(cls): # -> type[FormatSort]:
    ...
    @classmethod
    def get_testcases(cls, include_onlymatching=...): # -> Generator[Any, Any, None]:
        ...
    
    @classmethod
    def get_webpage_testcases(cls): # -> Generator[Any, Any, None]:
        ...
    ...
    @classmethod
    def description(cls, *, markdown=..., search_examples=...): # -> str | partial[classproperty]:
        """Description of the extractor"""
        ...
    
    def extract_subtitles(self, *args, **kwargs): # -> dict[Any, Any]:
        ...
    ...
    def extract_comments(self, *args, **kwargs): # -> Callable[[], dict[str, None] | dict[str, int | list[Any] | None]] | None:
        ...
    
    def extract_automatic_captions(self, *args, **kwargs): # -> dict[Any, Any]:
        ...
    
    def mark_watched(self, *args, **kwargs): # -> None:
        ...
    
    def geo_verification_headers(self): # -> dict[Any, Any]:
        ...
    ...
    @classmethod
    def extract_from_webpage(cls, ydl, url, webpage): # -> Generator[dict[str, Any | str] | Any, Any, None]:
        ...
