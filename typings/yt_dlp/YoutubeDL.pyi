...
class YoutubeDL:
    ...
    def to_console_title(self, message=..., progress_state=..., percent=...): # -> None:
        ...
    ...
    def get_output_path(self, dir_type=..., filename=...): # -> LiteralString | str:
        ...
    ...
    def prepare_outtmpl(self, outtmpl, info_dict, sanitize=...): # -> tuple[str, dict[Any, Any]]:
    ...
    def prepare_filename(self, info_dict, dir_type=..., *, outtmpl=..., warn=...): # -> LiteralString | str:
    ...
    def extract_info(self, url, download=..., ie_key=..., extra_info=..., process=..., force_generic_extractor=...): # -> dict[str, str | list[Any]] | None:
        """
    ...
    def build_format_selector(self, format_spec): # -> Callable[..., Generator[Any, Any, None]]:
        class TokenIterator:
            ...
    ...
    def process_subtitles(self, video_id, normal_subtitles, automatic_captions): # -> dict[Any, Any] | None:
        """Select the requested subtitles and their format"""
        ...
    
    def dl(self, name, info, subtitle=..., test=...): # -> tuple[Literal[True], Literal[False]] | tuple[Any, Literal[True]] | Any:
        ...
    ...
    @staticmethod
    def sanitize_info(info_dict, remove_private_keys=...): # -> dict[Any, dict[Any, Any] | list[Any] | str | Any | int | float | bool] | list[Any] | str | int | float | bool:
        """ Sanitize the infodict for converting to json """
        ...
    
    @staticmethod
    def filter_requested_info(info_dict, actually_filter=...): # -> dict[Any, dict[Any, dict[Any, Any] | list[Any] | str | Any | int | float | bool] | list[Any] | str | Any | int | float | bool] | list[Any] | str | int | float | bool:
    ...
    def pre_process(self, ie_info, key=..., files_to_move=...): # -> tuple[dict[Any, Any] | Any, Any]:
        ...
    ...
    def proxies(self): # -> dict[str, Any | str] | dict[str, str]:
