...
class _MatchParser:
    ...
    def advance(self, by): # -> Match[Any] | str | int:
        ...
    
    def consume(self, r): # -> Match[Any] | str | int:
        ...
...
class Block:
    ...
    @classmethod
    def parse(cls, parser): # -> Self | None:
        ...
