...
def pad_block(block, padding_mode): # -> list[Any | int]:
    """
...
def aes_cbc_encrypt(data, key, iv, *, padding_mode=...): # -> list[Any]:
    """
...
def iter_vector(iv): # -> Generator[Any, Any, Never]:
    ...
...
def iter_mix_columns(data, matrix): # -> Generator[Any | int, Any, None]:
    ...
