...
class FileDownloader:
    ...
    @classmethod
    def format_eta(cls, seconds): # -> LiteralString:
        ...
    ...
    @classmethod
    def calc_eta(cls, start_or_rate, now_or_remaining, total=..., current=...): # -> int | None:
        ...
    ...
    @staticmethod
    def filesize_or_none(unencoded_filename): # -> int:
        ...
    ...
    def temp_name(self, filename): # -> Literal['-']:
    ...
    def wrap_file_access(action, *, fatal=...): # -> partial[partialmethod[Any]]:
        ...
    
    @wrap_file_access('open', fatal=True)
    def sanitize_open(self, filename, open_mode): # -> tuple[BinaryIO | Any | TextIO | locked_file, Any | LiteralString | str]:
        ...
    ...
    def download(self, filename, info_dict, subtitle=...): # -> tuple[Literal[True], Literal[False]] | tuple[Any, Literal[True]]:
