...
class FlvReader(io.BytesIO):
    ...
    def read_asrt(self): # -> dict[str, list[Any]]:
        ...
    
    def read_afrt(self): # -> dict[str, list[Any]]:
        ...
    
    def read_abst(self): # -> dict[str, Any | list[Any]]:
        ...
    
    def read_bootstrap_info(self): # -> dict[str, Any | list[Any]]:
        ...
    


def read_bootstrap_info(bootstrap_bytes): # -> dict[str, Any | list[Any]]:
    ...

def build_fragments_list(boot_info): # -> list[Any]:
...
def remove_encrypted_media(media): # -> list[Any]:
    ...
